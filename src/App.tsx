      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <Button className="w-full h-14 text-lg rounded-2xl bg-[#0a2540] dark:bg-white dark:text-[#0a2540]">Book a Call</Button>
          </motion.div>
        )}
      </AnimatePresence>
    </nav>
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 sm:gap-16 lg:gap-24 items-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-8 sm:gap-10 items-center justify-center lg:justify-start">
                <Button size="lg" className="w-full sm:w-auto rounded-full px-12 h-16 text-lg font-bold bg-[#0a2540] hover:bg-[#3b82f6] text-white group transition-all duration-300 shadow-xl">
                  Book a Free Call
                </Button>
      ...
      <section className="py-20 sm:py-32 bg-white dark:bg-slate-950">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <Button size="lg" className="w-full sm:w-auto rounded-full px-12 h-16 text-lg font-bold bg-[#0a2540] hover:bg-[#3b82f6] text-white transition-all duration-300 shadow-xl">
              Get Started Now
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 shrink-0">
               <Button size="lg" className="rounded-2xl px-10 h-16 bg-[#0a2540] hover:bg-[#3b82f6] text-white font-bold transition-all shadow-xl group flex items-center gap-3">
      ...
      <section className="py-12 sm:py-20 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <Button size="lg" className="w-full sm:w-auto rounded-full px-10 h-16 text-lg font-bold bg-white text-[#0a2540] hover:bg-[#3b82f6] hover:text-white transition-all duration-300 shadow-xl relative z-10 group">
              Book a Free Call
